...
class QtLegacyGLMeshMolecularViewer(QOpenGLWidget):
    ...
    def _create_mesh_data(self):
        ...
        atom_vertices, atom_normals, atom_colors, atom_indices = self._create_sphere_mesh_data()
        ...
        if atom_vertices is not None:
            ...
            atom_colors_rgb = atom_colors[:, :3]  # Remove alpha channel
            self.atoms_mesh = LegacyGLMesh(
