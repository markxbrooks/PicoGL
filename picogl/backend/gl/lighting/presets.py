...
CAMERA_ORIGIN_LIGHT = LightSource(
...
SECONDARY_LIGHTS: dict[GLFixedFunctionCapability, LightSource] = {
    GLFixedFunctionCapability.LIGHT1: LightSource(
        position=Vec4(-10.0, -10.0, -10.0, 1.0), **_SOFT
    ),
    GLFixedFunctionCapability.LIGHT2: LightSource(
        position=Vec4(90.0, 90.0, 90.0, 1.0), **_SOFT
    ),
    GLFixedFunctionCapability.LIGHT3: LightSource(
        position=Vec4(-90.0, -90.0, -90.0, 1.0), **_SOFT
    ),
    GLFixedFunctionCapability.LIGHT4: LightSource(
