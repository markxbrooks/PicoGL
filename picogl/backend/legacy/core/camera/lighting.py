...
def set_second_light_state(second_light_state: bool) -> None:
    ...
    if second_light_state:
        ...
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT1, GLLightParameter.POSITION, [-10.0, -10.0, -10.0, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT1, GLLightParameter.DIFFUSE, [0.5, 0.5, 0.5, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT1, GLLightParameter.SPECULAR, [0.3, 0.3, 0.3, 1.0])
        GLCapabilityDriver.enable(GLFixedFunctionCapability.LIGHT2)
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT2, GLLightParameter.POSITION, [90.0, 90.0, 90.0, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT2, GLLightParameter.DIFFUSE, [0.5, 0.5, 0.5, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT2, GLLightParameter.SPECULAR, [0.3, 0.3, 0.3, 1.0])
        GLCapabilityDriver.enable(GLFixedFunctionCapability.LIGHT3)
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT3, GLLightParameter.POSITION, [-90.0, -90.0, -90.0, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT3, GLLightParameter.DIFFUSE, [0.5, 0.5, 0.5, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT3, GLLightParameter.SPECULAR, [0.3, 0.3, 0.3, 1.0])
        GLCapabilityDriver.enable(GLFixedFunctionCapability.LIGHT4)
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT4, GLLightParameter.POSITION, [270.0, 270.0, 270.0, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT4, GLLightParameter.DIFFUSE, [0.5, 0.5, 0.5, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT4, GLLightParameter.SPECULAR, [0.3, 0.3, 0.3, 1.0])
    else:
...
def setup_lighting(mode: int = 0) -> None:
    ...
    if mode == 0:
        ...
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT0, GLLightParameter.POSITION, light_pos)
        # Set light color_array
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT0, GLLightParameter.DIFFUSE, [1.0, 1.0, 1.0, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT0, GLLightParameter.SPECULAR, [1.0, 1.0, 1.0, 1.0])
        GLLightSource.lightf(GLFixedFunctionCapability.LIGHT0, GLLightParameter.AMBIENT, [0.2, 0.2, 0.2, 1.0])
        glMaterialf(GLFace.FRONT_AND_BACK, GLLightParameter.SHININESS, 128.0 * current_shininess)
