...
from picogl.backend.gl.api.enable import gl_disable, gl_enable, gl_enable_capability_list
...
def configure_point_rendering() -> None:
    ...
    gl_enable_capability_list(
        [GLPipelineCapability.BLEND, GLPointCapability.PROGRAM_POINT_SIZE]
    )
