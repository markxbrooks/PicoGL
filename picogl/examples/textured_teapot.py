"""
Textured PicoGL Teapot Example

This example demonstrates how to load and render a textured teapot using PicoGL.
It uses the TextureRenderer to handle texture loading and rendering.

Features:
- Loads teapot2.obj with UV coordinates
- Applies texture from resources directory
- Supports multiple texture formats (DDS, TGA, PNG)
- Interactive controls for rotation and zoom
- Mixes texture with vertex colors
...
def main() -> None:
    """Set up the textured teapot object and show it."""
    print("🚀 Loading Textured Teapot...")
    ...
    print("🚀 Starting textured teapot renderer...")
