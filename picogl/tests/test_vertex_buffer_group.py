...
class TestVertexBufferGroup(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.gl_patches = [
            ...
            patch('picogl.buffers.vertex.legacy.gl_enableVertexAttribArray'),
            ...
            patch('picogl.backend.legacy.core.vertex.buffer.vertex.gl_enableClientState'),
            ...
            patch('picogl.backend.legacy.core.vertex.buffer.client_states.gl_enableClientState'),
