...
def log_properties(loader: "ObjectLoader"):
    ...
    log.message(f"Total vertices: {len(loader.CUBE_DATA) // 3}")
    ...
    log.message(f"First few vertices: {loader.CUBE_DATA[:9]}")
    ...
    log.message(f"Vertices: {len(single_index_obj.CUBE_DATA) // 3}")
